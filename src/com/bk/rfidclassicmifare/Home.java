package com.bk.rfidclassicmifare;
...
public class Home extends Activity {
	 ...
	 private NfcAdapter nfcAdapter;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        if(nfcAdapter == null){
	            Toast.makeText(this,
	                    "NFC NOT supported on this devices! Please buy NFC Enabled Device to read TAG",
	                    Toast.LENGTH_LONG).show();
	           
	        }else if(!nfcAdapter.isEnabled()){
	            Toast.makeText(this,
	                    "NFC NOT Enabled! Please enable NFC First from settings",
	                    Toast.LENGTH_LONG).show();
